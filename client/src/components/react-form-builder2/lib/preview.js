...
var _sortableFormElements = _interopRequireDefault(
  require("./sortable-form-elements")
);
  ...
  (function (_React$Component) {
    ...
    function Preview(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(Preview).call(this, props)
      );
      ...
      _defineProperty(
        ...
        function (e) {
          if (
            _this.editForm.current &&
            !_this.editForm.current.contains(e.target)
          ) {
      ...
      [
        ...
        },
        {
          ...
          value: function getElement(item, index) {
            var SortableFormElement =
              _sortableFormElements["default"][item.element];
