...
function DesignBlockToolbar(props) {
    ...
    return(
        <div>
            ...
            >
                <DialogTitle id="alert-dialog-title">{"Delete design block?"}</DialogTitle>
                <DialogActions>
							...
							<div className={classes.root}>
								<Grid container spacing={3} >
									...
									<Grid item xs={12}>
                                        {content === "wowza" && (
                                            <div>
                                                ...
                                                <p>Need help? Click here for instructions on setting up a Wowza Live stream.</p>
                                            </div>
                                        )}
                                        {content === "youtube-live" && (
                                            <div>
                                                ...
                                                <p>Need help? Click here for instructions on setting up a YouTube Live stream.</p>
                                                <p>Heads up! YouTube may take down any streams containing copyrighted music.</p>
                                            </div>
                                        )}
									...
									<Grid item xs={12}id="save-button">
                                        <button className="Button1" onClick={handleCloseStreamSettings}>
                                            Save
                                        </button>
									</Grid>
								</Grid>
...
export default DesignBlockToolbar;