        ...
        return(
            <div>
                ...
                <div className="form-box shadow-border">
                        <TitleLink />
                        <EventCatSelect />
                        <DateTimePickers /><br></br>
                        <label for="event-color">Event Color</label><br></br>
                        <label for="event-color">Tip: picking a darker color will help buttons stand out.</label>
                        <EventColor />
                        <br></br>
                    <a href="/Design">
    ...
    return (
        <div>
            <FormControl variant="outlined" className={classes.formControl}>
                <TextField id="title" label="Event Title" variant="outlined" /><br></br>
                <TextField 
                    id="event-link" 
                    label="Event Link" 
                    variant="outlined" 
                    InputProps={{
                        endAdornment: <InputAdornment position="end">.eventscape.io</InputAdornment>,
                    }}
                />
            </FormControl>
        </div>
      ...
      <div>
        ...
        <FormControl variant="outlined" className={classes.formControl}>
          ...
          >
            ...
            <MenuItem value={'business_professional'}>Business & Professional</MenuItem>
            <MenuItem value={'charity_causes'}>Charity & Causes</MenuItem>
            <MenuItem value={'education'}>Education</MenuItem>
            <MenuItem value={'fashion'}>Fashion</MenuItem>
            <MenuItem value={'government_politics'}>Government & Politics</MenuItem>
            <MenuItem value={'music'}>Music</MenuItem>
            <MenuItem value={'performing_visual_arts'}>Performing & Visual Arts</MenuItem>
            <MenuItem value={'religion_spirituality'}>Religion & Spirituality</MenuItem>
