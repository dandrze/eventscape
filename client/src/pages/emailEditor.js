...
import Cancel from '../components/cancel.svg';
      ...
      render(){
          return(
              ...
              <div className="design">
                  ...
                  <div id="topButtons">
                      <SendTestEmail />
                      <div id='status'><StatusSelect /></div>
                      <button className='Button1' id="save">Save</button>
                  </div>
                  ...
                  <div id='designBoard'>
                    <div id='emailInputs'>
                        ...
                        <div className='inputDiv'>
                                <label htmlFor="toSelect" id='emailLabel'>To: </label>
                                <div id="toSelect"><ToSelect /></div> 
                        </div>

                        <div className='inputDiv'>
                                <label htmlFor="from" id='emailLabel'>From: </label>
                                <input type='text' id="emailInput" name="from" placeholder=""></input><br></br>
                        </div>
                        
                        <div className='inputDiv'>
                            <label htmlFor="subject" id='emailLabel'>Subject: </label>
                            <input type='text' id="emailInput" name="subject" placeholder="" value="Thank You for Registering for {Event_Name}"></input>
                        </div>

                        <div className='inputDiv'>
                            <label htmlFor="sendTime" id='emailLabel'>Scheduled Send Time: </label><br></br>
                            <DateTimePickers />
                        </div>
